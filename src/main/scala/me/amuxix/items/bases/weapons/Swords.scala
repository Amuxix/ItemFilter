...
sealed abstract class OneHandedSword(dropLevel: Int, `class`: String) extends Sword(3, 2, dropLevel, `class` + "One Handed") {
...
sealed abstract class ThrustingOneHandedSword(dropLevel: Int) extends Sword(4, 1, dropLevel, "Thrusting ")
