...
trait ImplicitConversions {
  ...
  implicit def string2OptionBaseType(string: Seq[String]): Option[BaseType] = Some(BaseType(string:_*))
  implicit def String2OptionItemClass(string: String): Option[ItemClass] = Some(ItemClass(string))
  implicit def String2OptionItemClass(string: Seq[String]): Option[ItemClass] = Some(ItemClass(string:_*))
  implicit def tuple22OptionDropLevel(tuple: (Operator, Int)): Option[DropLevel] = Some(DropLevel(tuple._1, tuple._2))
  implicit def tuple22OptionDropLevel(tuple: (String, Int)): Option[DropLevel] = Some(DropLevel(tuple._1, tuple._2))
  ...
  implicit def tuple22OptionLinkedSockets(tuple: (String, Int)): Option[LinkedSockets] = Some(LinkedSockets(tuple._1, tuple._2))
  ...
  implicit def tuple22OptionHeight(tuple: (String, Int)): Option[Height] = Some(Height(tuple._1, tuple._2))
  ...
  implicit def tuple22OptionWidth(tuple: (String, Int)): Option[Width] = Some(Width(tuple._1, tuple._2))
