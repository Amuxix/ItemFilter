...
trait ImplicitConversions {
  ...
  implicit def tuple22OptionItemLevel(tuple: (Operator, Int)): Option[ItemLevel] = Some(ItemLevel(Left(tuple._1), tuple._2))
  implicit def tuple22OptionItemLevel2(tuple: (String, Int)): Option[ItemLevel] = Some(ItemLevel(Left(tuple._1), tuple._2))
  implicit def tuple22OptionItemLevel3(tuple: (Int, Int)): Option[ItemLevel] = Some(ItemLevel(Right(tuple._1), tuple._2))
  ...
  implicit def tuple22OptionRarity(tuple: (Operator, GameRarity)): Option[Rarity] = Some(Rarity(tuple._1, tuple._2))
  implicit def tuple22OptionRarity2(tuple: (String, GameRarity)): Option[Rarity] = Some(Rarity(tuple._1, tuple._2))
